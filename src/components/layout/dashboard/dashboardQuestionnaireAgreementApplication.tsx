...
const Questionnaire = () => {
  const projects: Project[] = [
    ...
    { name: 'Deposit at Vaultopia?', selectionType: 'input', options: [{ amount: 500 }] },

    { name: 'Key Deposit', selectionType: 'input', options: [{ amount: 300 }] },
   {name: 'Require the tenant to authorize a credit report?', selectionType: 'radio', options: [{ value: 'yes', label: `Yes` }, { value: 'no', label: 'No' }] },
  ];
        ...
        <div>
          <div className='flex flex-row gap-2'>
            ...
            <div>
              ...
              <form action={() => { }} className='space-y-4 pr-6'>
                <div>
